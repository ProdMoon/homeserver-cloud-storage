...
export function TrashView() {
  ...
  return (
    <div className="flex flex-col gap-5">
      <header>
        <div className="font-mono text-[0.72rem] uppercase tracking-[0.16em] text-accent">Trash</div>
        <h1 className="mt-3 text-[clamp(2rem,5vw,3.5rem)] leading-[1.05] tracking-[-0.04em]">Deleted items</h1>
      </header>
        ...
        <div className="min-w-full w-max">
          ...
          {trashItems.map((item) => (
            ...
            >
              ...
              <span className="break-words font-mono text-[0.82rem] text-ink-muted">{item.originalPath}</span>
